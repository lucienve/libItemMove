...
---@field GetPartialSlots fun(self: MoveContext, itemString: string|number, partialSlotIdsTable: table[]) Appends eligible partial slot data { slotId, currentQty, roomLeft }
...
---@field ScanPartialSlots fun(self: BaseContext, containers: number[], itemString: string|number, partialSlotIdsTable: table[]) Scans containers for partial stacks
