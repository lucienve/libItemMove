...
* **Cross-Version API Adapter**: Seamlessly supports **Classic Era (1.15.x)**, **WoW Forever (1.60.x)**, **Mists of Pandaria Classic (5.5.x)**, and modern **Retail (11.x/12.x `C_Container`)**.
